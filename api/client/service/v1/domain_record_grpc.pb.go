...
func (c *domainServiceClient) GetDomainRecord(ctx context.Context, in *DRRequest, opts ...grpc.CallOption) (*DRResponse, error) {
	out := new(DRResponse)
	err := c.cc.Invoke(ctx, "/client.service.v1.DomainService/GetDomainRecord", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *domainServiceClient) UpdateDomainRecord(ctx context.Context, in *UpdateDomainRequest, opts ...grpc.CallOption) (*UpdateDomainResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/client.service.v1.DomainService/UpdateDomainRecord", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DomainService_GetDomainRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/client.service.v1.DomainService/GetDomainRecord",
	}
...
func _DomainService_UpdateDomainRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/client.service.v1.DomainService/UpdateDomainRecord",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var DomainService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "client.service.v1.DomainService",
